...
import cn.CrodSou.line.v_requester_s2_line;

public class v_requester_s2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 2931656230698126411L;
	JButton button;
	...
	v_requester_s2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_s2_line v_requester_s2_line = new v_requester_s2_line();
				v_requester_s2_line.s2line1(v_requester, x1, x2, c1, c2, s1, s2down, s2up, d, delta);
			}
		});
	}
}
