...
import cn.CrodSou.line.alpha_x2_line;

public class alpha_x2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -7975582097491056008L;
	JButton button;
	...
	alpha_x2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_x2_line alpha_x2_line = new alpha_x2_line();
				alpha_x2_line.x2line1(alpha, x1, x2down, x2up, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
