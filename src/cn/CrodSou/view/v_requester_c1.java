...
import cn.CrodSou.line.v_requester_c1_line;

public class v_requester_c1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 283566660661014982L;
	JButton button;
	...
	v_requester_c1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_c1_line v_requester_c1_line = new v_requester_c1_line();
				v_requester_c1_line.c1line1(v_requester, x1, x2, c1down, c1up, c2, s1, s2, d, delta);
			}
		});
	}
}
