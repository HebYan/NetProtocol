...
import cn.CrodSou.line.v_requester_c2_line;

public class v_requester_c2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 4707521327970681680L;
	JButton button;
	...
	v_requester_c2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_c2_line v_requester_c2_line = new v_requester_c2_line();
				v_requester_c2_line.c2line1(v_requester, x1, x2, c1, c2down, c2up, s1, s2, d, delta);
			}
		});
	}
}
