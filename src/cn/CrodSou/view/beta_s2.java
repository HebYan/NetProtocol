...
import cn.CrodSou.line.beta_s2_line;

public class beta_s2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -5776666295378042365L;
	JButton button;
	...
	beta_s2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_s2_line beta_s2_line = new beta_s2_line();
				beta_s2_line.s2line1(beta, x1, x2, c1, c2, s1, s2down, s2up, d, delta);
			}
		});
	}
}
