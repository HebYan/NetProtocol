...
import cn.CrodSou.line.v_requester_d_line;

public class v_requester_d extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -7796959039999797037L;
	JButton button;
	...
	v_requester_d() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_d_line v_requester_d_line = new v_requester_d_line();
				v_requester_d_line.dline1(v_requester, x1, x2, c1, c2, s1, s2, ddown, dup, delta);
			}
		});
	}
}
