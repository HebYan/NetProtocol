...
import cn.CrodSou.line.alpha_delta_line;

public class alpha_delta extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 1347793540480154448L;
	JButton button;
	...
	alpha_delta() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_delta_line alpha_delta_line = new alpha_delta_line();
				alpha_delta_line.deltaline1(alpha, x1, x2, c1, c2, s1, s2, d, deltadown, deltaup);
			}
		});
	}
}
