...
import cn.CrodSou.line.beta_c1_line;

public class beta_c1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -5939933542579128046L;
	JButton button;
	...
	beta_c1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_c1_line beta_c1_line = new beta_c1_line();
				beta_c1_line.c1line1(beta, x1, x2, c1down, c1up, c2, s1, s2, d, delta);
			}
		});
	}
}
