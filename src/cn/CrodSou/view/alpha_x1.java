...
import cn.CrodSou.line.alpha_x1_line;

public class alpha_x1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -3631689835053992291L;
	JButton button;
	...
	alpha_x1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_x1_line alpha_x1_line = new alpha_x1_line();
				alpha_x1_line.x1line1(alpha, x1down, x1up, x2, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
