...
import cn.CrodSou.line.Rmax_c2_line;

public class Rmax_c2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -7631468548740320556L;
	JButton button;
	...
	Rmax_c2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Rmax_c2_line Rmax_c2_line = new Rmax_c2_line();
				Rmax_c2_line.c2line1(Rmax, x1, x2, c1, c2down, c2up, s1, s2, d, delta);
			}
		});
	}
}
