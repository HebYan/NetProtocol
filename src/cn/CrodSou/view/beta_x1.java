...
import cn.CrodSou.line.beta_x1_line;

public class beta_x1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -1229547963035395721L;
	JButton button;
	...
	beta_x1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_x1_line beta_x1_line = new beta_x1_line();
				beta_x1_line.x1line1(beta, x1down, x1up, x2, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
