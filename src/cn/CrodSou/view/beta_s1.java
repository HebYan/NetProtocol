...
import cn.CrodSou.line.beta_s1_line;

public class beta_s1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 6471534817327974650L;
	JButton button;
	...
	beta_s1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_s1_line beta_s1_line = new beta_s1_line();
				beta_s1_line.s1line1(beta, x1, x2, c1, c2, s1down, s1up, s2, d, delta);
			}
		});
	}
}
