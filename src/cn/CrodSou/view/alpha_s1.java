...
import cn.CrodSou.line.alpha_s1_line;

public class alpha_s1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 3931762390459637898L;
	JButton button;
	...
	alpha_s1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_s1_line alpha_s1_line = new alpha_s1_line();
				alpha_s1_line.s1line1(alpha, x1, x2, c1, c2, s1down, s1up, s2, d, delta);
			}
		});
	}
}
