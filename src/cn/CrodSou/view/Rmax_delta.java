...
import cn.CrodSou.line.Rmax_delta_line;

public class Rmax_delta extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -2777545416857908249L;
	JButton button;
	...
	Rmax_delta() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Rmax_delta_line Rmax_delta_line = new Rmax_delta_line();
				Rmax_delta_line.deltaline1(Rmax, x1, x2, c1, c2, s1, s2, d, deltadown, deltaup);
			}
		});
	}
}
