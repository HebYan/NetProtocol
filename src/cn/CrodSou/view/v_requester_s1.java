...
import cn.CrodSou.line.v_requester_s1_line;

public class v_requester_s1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 7441035040488850434L;
	JButton button;
	...
	v_requester_s1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_s1_line v_requester_s1_line = new v_requester_s1_line();
				v_requester_s1_line.s1line1(v_requester, x1, x2, c1, c2, s1down, s1up, s2, d, delta);
			}
		});
	}
}
