...
import cn.CrodSou.line.beta_delta_line;

public class beta_delta extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 2409888297716383918L;
	JButton button;
	...
	beta_delta() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_delta_line beta_delta_line = new beta_delta_line();
				beta_delta_line.deltaline1(beta, x1, x2, c1, c2, s1, s2, d, deltadown, deltaup);
			}
		});
	}
}
