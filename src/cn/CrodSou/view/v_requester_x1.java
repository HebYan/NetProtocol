...
import cn.CrodSou.line.v_requester_x1_line;

public class v_requester_x1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 8086738053971886000L;
	JButton button;
	...
	v_requester_x1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_x1_line v_requester_x1_line = new v_requester_x1_line();
				v_requester_x1_line.x1line1(v_requester, x1down, x1up, x2, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
