...
import cn.CrodSou.line.alpha_c1_line;

public class alpha_c1 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 4154994676037552152L;
	JButton button;
	...
	alpha_c1() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_c1_line alpha_c1_line = new alpha_c1_line();
				alpha_c1_line.c1line1(alpha, x1, x2, c1down, c1up, c2, s1, s2, d, delta);
			}
		});
	}
}
