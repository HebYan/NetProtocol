...
import cn.CrodSou.line.v_requester_x2_line;

public class v_requester_x2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 9221169960280660181L;
	JButton button;
	...
	v_requester_x2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				v_requester_x2_line v_requester_x2_line = new v_requester_x2_line();
				v_requester_x2_line.x2line1(v_requester, x1, x2down, x2up, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
