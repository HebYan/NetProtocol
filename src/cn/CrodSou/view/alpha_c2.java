...
import cn.CrodSou.line.alpha_c2_line;

public class alpha_c2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = -6383138312067480315L;
	JButton button;
	...
	alpha_c2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				alpha_c2_line alpha_c2_line = new alpha_c2_line();
				alpha_c2_line.c2line1(alpha, x1, x2, c1, c2down, c2up, s1, s2, d, delta);
			}
		});
	}
}
