...
import cn.CrodSou.line.Rmax_s2_line;

public class Rmax_s2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 9216450973795284740L;
	JButton button;
	...
	Rmax_s2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Rmax_s2_line Rmax_s2_line = new Rmax_s2_line();
				Rmax_s2_line.s2line1(Rmax, x1, x2, c1, c2, s1, s2down, s2up, d, delta);
			}
		});
	}
}
