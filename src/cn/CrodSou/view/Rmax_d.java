...
import cn.CrodSou.line.Rmax_d_line;

public class Rmax_d extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 139677268298414503L;
	JButton button;
	...
	Rmax_d() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Rmax_d_line Rmax_d_line = new Rmax_d_line();
				Rmax_d_line.dline1(Rmax, x1, x2, c1, c2, s1, s2, ddown, dup, delta);
			}
		});
	}
}
