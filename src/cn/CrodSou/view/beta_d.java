...
import cn.CrodSou.line.beta_d_line;

public class beta_d extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 7252445032458511889L;
	JButton button;
	...
	beta_d() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_d_line beta_d_line = new beta_d_line();
				beta_d_line.dline1(beta, x1, x2, c1, c2, s1, s2, ddown, dup, delta);
			}
		});
	}
}
