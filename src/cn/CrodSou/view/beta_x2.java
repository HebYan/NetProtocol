...
import cn.CrodSou.line.beta_x2_line;

public class beta_x2 extends JPanel {
	/**
	 *
	 */
	private static final long serialVersionUID = 567985135622399384L;
	JButton button;
	...
	beta_x2() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				beta_x2_line beta_x2_line = new beta_x2_line();
				beta_x2_line.c1line1(beta, x1, x2down, x2up, c1, c2, s1, s2, d, delta);
			}
		});
	}
}
