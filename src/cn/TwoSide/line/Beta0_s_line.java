...
public class Beta0_s_line {
	...
	public void sline1(double Beta0[], double b, double c, double sdown, double sup, double k, double w, double e) {
		...
		JFreeChart mChart = ChartFactory.createXYLineChart("", "s", "β0", mCollection, PlotOrientation.VERTICAL, true,
				true, false);
		...
		ChartFrame mChartFrame = new ChartFrame("关于s的β0变化折线图", mChart);
		mChartFrame.pack();
